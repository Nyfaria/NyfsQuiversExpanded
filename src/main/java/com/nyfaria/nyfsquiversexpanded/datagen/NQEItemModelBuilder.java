...
public class NQEItemModelBuilder extends ItemModelBuilder {
    public NQEItemModelBuilder(ResourceLocation outputLocation, ExistingFileHelper existingFileHelper) {
